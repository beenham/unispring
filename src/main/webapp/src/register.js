...
export default class Register extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      studentNumber: "",
      borderColor: "none",
      passwordLength: "Password still needed",
      passwordState: "is-link",
      submitButton:"false"
    };
  }
  ...
  checkLength(pass){
    if(pass.length >= 8){
      this.setState({
        passwordLength: "Valid Password",
        passwordState: "is-success"
      });
    }else{
      this.setState({
        passwordLength: "Password not valid! Current length:" + pass.length,
        passwordState: "is-danger"
      });
    }
  }
            ...
            <div id="form-area">
              <form>
                ...
                <div className="form-group-elements">
                  <span className="tag is-info is-light">Password must be longer than 8 characters!</span>
                  <span className={this.state.passwordState+" tag is-light"}>{this.state.passwordLength}</span>
                </div>
                  ...
                  <div className="field">
                    ...
                    <div className="control has-icons-left has-icons-right">
                      <input
                          ...
                          onChange={e => { this.setState({password: e.target.value}); this.checkLength(e.target.value)}}
                      />
                      <span className="icon is-small is-left">
                  ...
                  <div className="field">
                    ...
                    <div className="control has-icons-left has-icons-right">
                      <input
                          ...
                          style={{borderColor: this.state.borderColor}}
                          onChange={e =>
                              this.passwordTest(e.target.value)
                          }
                      />
                      <span className="icon is-small is-left">
                      <i className="material-icons-outlined">lock</i>
