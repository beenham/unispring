...
class RegisterComponent extends Component{
    ...
    handleClick(event){
        ...
        console.log(payload);
        axios.post(apiBaseUrl+'/student/register', payload).then(function (response) {
                ...
                <div id="register-area">
                    <div id="header-links">
                        ...
                        <div className="buttons has-addons is-centered">
                            <a className="button" className="register-log-button" href="/login">Login</a>
                        </div>
                    </div>
                    <div id="form-area">
                        <form>
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="text" placeholder="First Name"
                                               name="firstName" onChange={e => this.setState({
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="text" placeholder="Surname"
                                               name="sureName" onChange={e => this.setState({
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <div className="select is-small">
                                            <select  name="gender" onChange={e => this.setState({
                                        ...
                                        {/*<input className="input is-small" type="text" placeholder="Gender" name="gender"*/}
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="number" placeholder="Student Number"
                                               name="studentNumber" onChange={e => this.setState({
                            ...
                            <div className="form-group-elements">
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="email" placeholder="Email"
                                               name="emailAddress" onChange={e => this.setState({
                              ...
                              <i className="material-icons-outlined">email</i>
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="password" placeholder="password"
                                               name="password" onChange={e => this.setState({
                                ...
                                <div className="field">
                                    <label className="label is-small">Re-enter Passowrd</label>
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="password" placeholder="password"
                                               name="password"/>
                                        <span className="icon is-small is-left">
                                ...
                                <div className="field">
                                    ...
                                    <div className="control has-icons-left has-icons-right">
                                        <input className="input is-small" type="number" placeholder="Phone Number"
                                               name="phoneNumber" onChange={e => this.setState({
                            ...
                            <div className="form-group-elements" id="register-address">
                                ...
                                <div id="address-boxes">
                                    <div className="field">
                                        ...
                                        <div className="control has-icons-left has-icons-right">
                                            <input className="input is-small" type="text" placeholder="Street Address"
                                                   name="streetAddress" onChange={e => this.setState({
                                  ...
                                  <i className="material-icons-outlined">location_on</i>
                                    ...
                                    <div className="field">
                                        <div className="control has-icons-left has-icons-right">
                                            <input className="input is-small" type="text" placeholder="Town" name="town"
                                                   onChange={e => this.setState({
                                                       town: e.target.value
                                                   })}/>
                                            <span className="icon is-small is-left">
                                  <i className="material-icons">domain</i>
                                    ...
                                    <div className="field">
                                        <div className="control has-icons-left has-icons-right">
                                            <input className="input is-small" type="text" placeholder="City" name="city"
                                                   onChange={e => this.setState({
                                                       city: e.target.value
                                                   })}/>
                                            <span className="icon is-small is-left">
                                  <i className="material-icons">location_city</i>
                                    ...
                                    <div className="field">
                                        <div className="control has-icons-left has-icons-right">
                                            {/*<input className="input is-small" type="text" placeholder="Country"*/}
                                            {/*       name="country" onChange={e => this.setState({*/}
                                            {/*    country: e.target.value*/}
                                            {/*})}/>*/}

                                                <div className="select is-small">
                                                    <select name="country" onChange={e => this.setState({
                                                        country: e.target.value
                                                    })}>
